...
{#if show}
	<div class="mb-6">
		<!-- Card shell -->
		<div class="overflow-hidden rounded-2xl border border-purple-200/80 bg-white shadow-lg shadow-purple-500/10 dark:border-purple-800/50 dark:bg-gray-900">
			...
			<div class="flex items-center gap-2.5 border-b border-gray-100 px-5 py-3.5 dark:border-gray-800">
				<span class="flex h-7 w-7 items-center justify-center rounded-lg bg-purple-100 dark:bg-purple-900/40">
		...
		<div class="relative mt-6 flex items-center gap-3">
			<div class="h-px flex-1 bg-gradient-to-r from-transparent via-gray-200 to-transparent dark:via-gray-700"></div>
			<span class="rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-[11px] font-medium tracking-wide text-gray-400 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-500">
				Track details
			</span>
			<div class="h-px flex-1 bg-gradient-to-r from-transparent via-gray-200 to-transparent dark:via-gray-700"></div>
		</div>
